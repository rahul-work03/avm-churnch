...
export const ScenesSection: React.FC = () => {
  // Top Row: 4 authentic scenic photos
  ...
  // Bottom Row: 4 authentic scenic photos
  ...
  return (
    <section className="py-6 sm:py-10 md:py-14 bg-white overflow-hidden select-none" data-node-id="279:2081">
      {/* Dark Navy Section Header Bar (Figma 279:2099, 279:2102, 279:2105, 279:2107) */}
