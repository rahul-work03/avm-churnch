                ...
                return (
                  ...
                  >
                    <motion.a
                      ...
                      className="group block w-full min-h-[175px] sm:min-h-[185px] bg-[#e2e8f0] hover:bg-[#d8e2ed] rounded-[20px] p-5 sm:p-6 text-center shadow-sm hover:shadow-md transition-colors duration-200 cursor-pointer"
                      title={`Open ${branch.name} location in Google Maps`}
                    >
                      {/* Circular Navy Pin Icon (Figma 286:3133: 51px x 51px) */}
                      <div className="w-[44px] h-[44px] sm:w-[51px] sm:h-[51px] rounded-full bg-[#003370] group-hover:bg-[#122f4a] group-hover:scale-110 transition-all duration-300 flex items-center justify-center mb-2.5 sm:mb-3 mx-auto shadow-inner">
