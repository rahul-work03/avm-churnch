...
export const BibleCollegeScenesSection: React.FC = () => {
  ...
  return (
    <section className="py-6 sm:py-10 md:py-14 bg-white overflow-hidden select-none" data-node-id="284:2612">
      {/* Dark Navy Section Header Bar (Figma 284:2612 / 284:2528) */}
