  ...
  return (
    <section className="relative pt-4 pb-12 sm:pb-16 md:pb-24 bg-transparent" data-node-id="275:810">
      <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Floating Identity & Vision Header Badge (Figma 275:830, 275:832, 275:835, 275:837) */}
        <div className="relative max-w-[754px] mx-auto bg-[#122f4a] rounded-[18px] sm:rounded-[36px] md:rounded-[44px] py-3.5 sm:py-5 md:py-6 px-0 text-center text-white shadow-xl -mb-6 sm:-mb-12 md:-mb-14 z-20 overflow-hidden flex items-center justify-between">
        ...
        {/* Mobile View: 2 Distinct Stacked Cards (Figma node 275:1083) */}
        ...
        {/* Desktop View: Unified 2-Column Vision & Mission Card (Figma node 275:829, 275:833, 275:834) */}
        <div className="hidden md:block bg-white rounded-[44px] shadow-2xl pt-20 lg:pt-24 pb-12 lg:pb-14 px-8 lg:px-16 border border-slate-100 relative z-10">
