  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Section Header */}
        <h2 className="font-poppins font-medium text-[#000000] text-2xl sm:text-3xl md:text-[38px] tracking-tight">
          Our Social Media Platforms
        </h2>
        <p className="font-poppins text-[#64748b] text-base sm:text-lg md:text-[20px] mt-2">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {socials.map((s, idx) => (
            ...
            >
              ...
              <span className="font-poppins font-medium text-[#0b131d] text-xl sm:text-2xl mt-4 group-hover:text-black transition-colors">
                {s.name}
              </span>
            </a>
          ))}
