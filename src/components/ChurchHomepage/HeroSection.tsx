...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative pt-3 pb-8 sm:pt-6 sm:pb-16 md:pt-8 md:pb-20 overflow-hidden">
      ...
      <div className="w-full flex items-center justify-between py-1.5 sm:py-3 md:py-4">
        ...
        <div className="flex-1 min-w-[12px] sm:min-w-[32px] h-[3px] sm:h-[6px] xl:h-[10px] bg-[#efbf04] rounded-r-full shadow-sm pointer-events-none" />

        {/* Main Title text */}
        <div className="text-center max-w-4xl mx-auto px-3 sm:px-6 md:px-12 flex-shrink min-w-0">
          <h1 className="font-philosopher font-bold text-[#003471] text-xl sm:text-3xl md:text-4xl lg:text-[46px] xl:text-[52px] leading-snug sm:leading-[1.2] tracking-tight">
          ...
          <p className="font-poppins text-[#0b0c1c] text-xs sm:text-sm md:text-base lg:text-[17px] leading-relaxed max-w-3xl mx-auto mt-2 sm:mt-3 md:mt-4 text-balance px-1">
        ...
        <div className="flex-1 min-w-[12px] sm:min-w-[32px] h-[3px] sm:h-[6px] xl:h-[10px] bg-[#efbf04] rounded-l-full shadow-sm pointer-events-none" />
      </div>

      <div className="relative max-w-[1440px] mx-auto px-3 sm:px-6 lg:px-8">
        {/* Featured 200+ ANM Churches Banner Card (1140px x 620px, rounded-[51px]) */}
        <div className="mt-4 sm:mt-8 md:mt-10 max-w-[1140px] mx-auto">
          <div className="relative w-full aspect-[16/9] sm:aspect-[1140/620] rounded-2xl sm:rounded-[28px] md:rounded-[40px] lg:rounded-[51px] overflow-hidden shadow-xl sm:shadow-2xl border border-amber-200/40 bg-slate-900 group">
            <Image
